g.report.part5 = function(metadatadir = c(), f0 = c(), f1 = c(), loglocation = c(),
  ...
  # Note: argument params_cleaning[["includenightcrit"]] and params_cleaning[["includedaycrit"]] is not used anymore, and can be depricated
  if (length(params_cleaning[["includedaycrit"]]) != 0 &
      length(params_cleaning[["includedaycrit.part5"]]) == 0) {
    params_cleaning[["includedaycrit.part5"]] = params_cleaning[["includedaycrit"]]
  }
  ...
  getValidDayIndices = function(x, window, params_cleaning) {
    if (window != "Segments") {
      if (params_cleaning[["includedaycrit.part5"]] >= 0 &
        ...
        params_cleaning[["includedaycrit.part5"]] = params_cleaning[["includedaycrit.part5"]] * 100
        ...
        params_cleaning[["includedaycrit.part5"]] = (params_cleaning[["includedaycrit.part5"]] / 24) * 100
      ...
      maxpernwday = 100 - params_cleaning[["includedaycrit.part5"]]
