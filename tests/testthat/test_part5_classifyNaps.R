...
test_that("is able to classifyNaps", {
  starttimes = c("2020-04-04 10:15:00", "2020-04-04 12:00:00",
                 "2020-04-04 12:18:00", "2020-04-04 19:39:00")
  endtimes = c("2020-04-04 10:40:00", "2020-04-04 12:16:00", 
  ...
  sibreport$start = as.POSIXct(sibreport$start)
  sibreport$end = as.POSIXct(sibreport$end)
