...
- Joan Capdevila Pujol contributed with a couple of bug fixes.
...
- Medical Research Council (MRC) grants MR/P012167/1, MC_UU_12015/3, and MR/P012167/1.
...
- National Institute of Health grants HL-094307 (AIP).
- Eli-Lilly Research Award Programme.

## How can I contribute to the GGIR development?

The development version of GGIR can be found on [github](https://github.com/wadpac/GGIR), which is also where you will find guidance on how to contribute to the package development. We welcome contributions to GGIR in time investment, constructive feedback, financially, or otherwise. 
...
**However, if you need dedicated support with the use of GGIR or need someone to adapt GGIR** then Vincent van Hees is available as indpendent consultant, see also: https://movementdata.nl/.
...
It is possible to run GGIR on a computing cluster to process multiple files in parallel. The way we did it on a Sun Grid Engine cluster is shown below, please note that some of these commands are specific to the computing cluster you are working on. Please consult your local cluster specilist to tailor this to your situation. In our case, we had three files:
