...
| n hours ignored at start of meas (if strategy=1, 3 or 5)        | number of hours ignored at the start of the measurement (if strategy = 1) or at the start of the `ndayswindow` (if strategy = 3 or 5) A log of decision made in part2.R       |
| n hours ignored at end of meas (if strategy=1, 3 or 5)          | number of hours ignored at the end of the measurement (if strategy = 1) or at the end of the `ndayswindow` (if strategy = 3 or 5). A log of decision made in part2.R         |
| n hours ignored at end of meas (if strategy = 1, 3 or 5)          | number of days of measurement after which all data is ignored (if strategy = 1, 3 or 5) A log of decision made in part2.R    |
