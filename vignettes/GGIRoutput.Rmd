...
### Old napping behaviour variables (to be deprecated)

These variables will be deprecated as napping, if detection is turned on, is now a behavioural category just like all other behaviours.
